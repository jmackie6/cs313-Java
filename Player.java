...
"            </div>");
        ...
        try{
            ...
            PreparedStatement pst = con.prepareStatement("SELECT * FROM players WHERE player_name =?");
            ...
            out.println("<h1> Player Name: " + player + "</h1><br>");
            while(rs.next()) {
                ...
                out.print("Player Score: "+ score + "<br>");
                out.print("Won Game: "+ winner + "<br><br>");
