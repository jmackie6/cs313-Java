	...
	<body>
 		...
 		<div id="left">
            ...
            <div name="2" id="2">
                ...
                <br><h2 name="game_date" id="game_date"><%= request.getParameter("date")%></h2><br/><br> 
                        
                Player Name:<input type="text" align="left"/>Add Value:<input type="text" align="center" min="1" max="3" size="2"/>
                <input type="button" value="Add To Total"/><input type="button" value="Subtract To Total"/> 
                <span align="right">Total: <p name="total"></p></span>
                Winner<input name="1" type="checkbox"/> <br><br>
